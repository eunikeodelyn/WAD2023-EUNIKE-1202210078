...
if (empty($error)) {
    ...
    if ($hasil <= 18.4) {
        echo "Underweight";
    } elseif ($hasil <= 18.5 - 24.9) {
        echo "Normal";
    } elseif ($hasil <= 25.0 - 39.9) {
        echo "Overweight";
    } elseif ($hasil >= 40) {
        echo "Obese";
    }
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary mb-3 mt-3 w-100" name="tambah">Hitung BMI</button>
                    </form>
                    ...
                    <?php 
                    if (isset($hasil)) {
                        echo "Hasil BMI anda adalah $hasil";
                    }
                    ?>
                    <!--  **********************  4  **************************     -->
